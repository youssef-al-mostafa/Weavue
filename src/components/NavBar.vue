...
<template>
  <nav class="flex py-[28px] ">
    <div class="nav-container flex flex-1 items-center justify-between ">
      <div class="lgo-cont gap-4 justify-center  shrink-0 items-center">
        <img class="logo h-17 w-auto" :src="imgUrl" alt="Weavue" />
      </div>
      <div class="menu-nav flex gap-9">
         <a class="menu-a text-[#333333] font-bold text-[19px] font-sans" href="">My Portfolio</a>
         <a class="menu-a text-[#333333] font-bold text-[19px] font-sans" href="">Github Repository</a>
         <a class="menu-a text-[#333333] font-bold text-[19px] font-sans" href="">Linked In</a>
      </div>
